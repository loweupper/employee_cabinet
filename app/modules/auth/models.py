...
class Session(Base):
    ...
    def __repr__(self):
        return (
            f"<Session id={self.id} user_id={self.user_id} revoked={self.is_revoked}>"
        )
...
class OTP(Base):
    ...
    __table_args__ = (
        ...
        # Индекс для быстрого поиска OTP по пользователю и цели.
...
from modules.permissions.models import (  # noqa: E402, F401
    RolePermission,
    UserPermission,
